...
import { BookOpen, Users, ArrowLeft, Eye, EyeOff, Loader } from 'lucide-react';

const SimulatedLogin: React.FC = () => {
            ...
            {role && (
              <div className="p-3 bg-blue-50 rounded-lg">
                <div className="flex items-center gap-2">
                  {role === 'student' ? <BookOpen size={16} className="text-blue-600" /> : <Users size={16} className="text-purple-600" />}
