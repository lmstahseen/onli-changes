...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Parse request body
    const { personal_path_lesson_id, num_questions, question_type }: GenerateQuizRequest = await req.json();
...
- Mix true and false answers roughly equally`;
    ...
    // Update the progress record to indicate quiz generation
    ...
    console.error('Error in generate-personal-path-quiz function:', error);
    return new Response(
