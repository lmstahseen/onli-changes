...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Parse request body
    const { personal_lesson_id, num_questions, question_type }: GenerateQuizRequest = await req.json();
...
- Mix true and false answers roughly equally`;
    ...
    console.error('Error in generate-personal-lesson-quiz function:', error);
    return new Response(
